...
namespace OnlineMarket
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            //container.LoadConfiguration("OnlineMarket");

            // TODO: Register your type's mappings here.
          container.RegisterType<OnlineMarketEntities>(new PerRequestLifetimeManager());
            container.RegisterType<UnitOfWork>();
           // container.RegisterType<ItemRepository>();
            container.RegisterType<ItemService>();
            container.RegisterType<DocumentService>();
            container.RegisterType<DocumentRepository>();
            container.RegisterType<LocationRepository>();
            container.RegisterType<SellerRepository>();
            container.RegisterType<MetadataService>();
            container.RegisterType<SellerService>();
        }
